...
Additionally I had to learn how to use the simulator and create a new environment using the correct keras dependency in order to use my local computer in order to train my model which took a few weeks to learn let alone run the model for 15 EPOCHs on a macbook pro. Time is a very crucial component.
